...
const ExRadio = () => {
  ...
  return (
    <PageContainer title="Radio" description="this is Radio page">
      {/* breadcrumb */}
      <Breadcrumb title="Radio" items={BCrumb}></Breadcrumb>
      {/* end breadcrumb */}
        ...
        <Grid item xs={12} lg={6} sm={6} display="flex" alignItems="stretch">
          <BaseCard title="Custom Color with Label">
            ...
            >
              <FormControlLabel
                value="end"
                control={<CustomRadioButton bgcolor="#0bb2fb" checked />}
                label="Primary"
                labelPlacement="end"
              />
              <FormControlLabel
                value="end"
                control={<CustomRadioButton bgcolor="#1e4db7" checked />}
                label="Secondary"
                labelPlacement="end"
              />
              <FormControlLabel
                value="end"
                control={<CustomRadioButton bgcolor="#39cb7f" checked />}
                label="Success"
                labelPlacement="end"
              />
              ...
              <FormControlLabel
                value="end"
                control={<CustomRadioButton bgcolor="#fc4b6c" checked />}
                label="Danger"
                labelPlacement="end"
              />
              ...
              <FormControlLabel
                value="end"
                control={<CustomRadioButton bgcolor="#fec90f" checked />}
                label="Warning"
                labelPlacement="end"
              />
            </Box>
