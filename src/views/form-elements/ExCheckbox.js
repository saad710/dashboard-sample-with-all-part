...
const ExCheckbox = () => {
  ...
  return (
    <PageContainer title="Checkbox" description="this is Checkbox page">
      {/* breadcrumb */}
      <Breadcrumb title="Checkbox" items={BCrumb}></Breadcrumb>
      {/* end breadcrumb */}
        ...
        <Grid item xs={12} lg={6} sm={6} display="flex" alignItems="stretch">
          <BaseCard title="Custom Checkbox with Color">
            ...
            >
              ...
              />
              <FormControlLabel
                control={<CustomCheckbox defaultChecked bgcolor="#1e4db7" />}
                label="Secondary"
              />
              <FormControlLabel
                control={<CustomCheckbox defaultChecked bgcolor="#39cb7f" />}
                label="Success"
              />
              <FormControlLabel
                control={<CustomCheckbox defaultChecked bgcolor="#fec90f" />}
                label="Warning"
              />
              <FormControlLabel
                control={<CustomCheckbox defaultChecked bgcolor="#fc4b6c" />}
                label="Error"
              />
            </Box>
          </BaseCard>
